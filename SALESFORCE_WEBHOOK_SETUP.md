...
5.  Fill in the details for the Outbound Message:
    ...
    *   **Protected Component**: Leave this **unchecked**.
...
4.  Configure the Flow Trigger:
    ...
    *   **When to Run the Flow for Updated Records**: Select **Only when a record is updated to meet the condition requirements**.
    *   **Optimize the Flow for**: Select **Actions and Related Records**.
    *   Disable **Add Asynchronous Path**
...
2.  Enter a **Flow Label**: `Trigger Handoff Orchestrator`
3.  Enter a **Flow API Name**: `Trigger_Handoff_Orchestrator` (this will auto-fill)
4.  Click **"Save"**.
